...
ps. Why do not select Jmeter due to it will consume too many CPU/Memory IO when launch the load generator and you have to set up more instances or container if you desired to hit high RPS
 - I was also familiar with Jmeter script and did the performace test with it

### Screenshots
Please check result-screenshot-example folder
 - pipeline screenshot for task 1
 - locust secreenshot example for task2 but it was previous project of load testing
